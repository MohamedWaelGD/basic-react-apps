    ...
    return (
        ...
        >
            <div className="flex items-center gap-3">
                {isCompleted ? (
                    <button
                        className="flex h-6 w-6 cursor-pointer items-center justify-center rounded-full border-2 border-green-500 bg-green-500 text-white"
                        title="Completed"
                    ...
                    <button
                        className="flex h-6 w-6 cursor-pointer items-center justify-center rounded-full border-2 border-blue-400 transition hover:bg-blue-100"
                        title="Mark as done"
                        onClick={toggleCheckTodo}
                    ></button>
                )}
